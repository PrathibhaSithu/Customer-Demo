      ...
      header .navigation li a.active {
        ...
        color: white;
         ...
         .container
          ...
          .updateaccount-form p
          {
          font-size:18px;
          text-tranform:uppercase;
          margin: 8px 0;
          }
          .updateaccount-form input{
...
<body>
     ...
     <header>
      ...
      %>
    <div class="updateaccount-form">	
    <div class="updatefrom"><h1>Update Acccount Details</h1></div>
    ...
    <br>
    <input type="submit" class="btn" name="submit" value="Update my date"> 
    </form>
      </div>
