...
<title>Insert title here</title>
 ...
 <style>
      body
        {
        background-image:url(https://img.freepik.com/premium-vector/fast-food-seller-buyer-color-faceless-characters-restaurant-controlled-online-food-ordering-cafe-cash-register-isolated-cartoon-illustration-web-graphic-animation_151150-816.jpg?w=2000);
        height: 100vh;
...
<body>
     ...
     <header>
       ...
       <div class="regfrom"><h1>Registration</h1></div>
                        ...
                        <div class="footer-col">
                         ...
                         <div class="social-links">
                           ...
                           <p> This is a website of a online food ordering services,
                               we produce all the health services and all accessories for pets &amp; SEO Learner.</p>
                         <br><br>
                         <h4>Follow Us</h4>
