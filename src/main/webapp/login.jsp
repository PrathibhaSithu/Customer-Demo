...
<style>
        body
        {
        background-image:url(https://images.pexels.com/photos/687824/pexels-photo-687824.jpeg?auto=compress&cs=tinysrgb&w=600);
...
<body>
     ...
     <div class="form">
      <form action="log"  method="post"> 
       ...
       <p class="message" style="color: #ffffff;">Not Registered? <a href="CusInsert.jsp" class="btn">Register</a></p>
      </form>
      </div>
      </div>
